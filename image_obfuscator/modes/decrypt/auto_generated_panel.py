...
class ProcSettingsPanel (wx.Panel):
    __slots__ = (
        'XORA', 'XORB', 'XOREncryption', 'XORG', 'XORR', 'coreVersion', 'cuttingCol', 'cuttingRow', 'flipChunks', 'm_staticText1',
        'm_staticText11', 'm_staticText5', 'm_staticText6', 'm_staticText61', 'm_staticText611', 'mappingA', 'mappingB',
        'mappingG', 'mappingR', 'noiseFactor', 'noiseFactorNum', 'noiseXor', 'origHeight', 'origWidth', 'shuffleChunks',
        'xorPanel'
    )
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.Size(-1, -1), style=wx.TAB_TRAVERSAL, name=wx.EmptyString):
        ...
        sbSizer3 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, u"加密参数补全"), wx.VERTICAL)

        bSizer10 = wx.BoxSizer(wx.HORIZONTAL)

        self.m_staticText5 = wx.StaticText(sbSizer3.GetStaticBox(), wx.ID_ANY, u"参数版本", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText5.Wrap(-1)

        self.m_staticText5.SetToolTip(u"当前图像加密时的加密参数版本，不同版本段将产生不同的解密结果，使用加密参数也会不同")

        bSizer10.Add(self.m_staticText5, 0, wx.ALIGN_CENTER_VERTICAL, 5)

        self.coreVersion = wx.SpinCtrl(sbSizer3.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTER_HORIZONTAL | wx.SP_ARROW_KEYS | wx.TE_PROCESS_ENTER, 1, 1, 1)
        self.coreVersion.SetToolTip(u"当前图像加密时的加密参数版本，不同版本段将产生不同的解密结果，使用加密参数也会不同")

        bSizer10.Add(self.coreVersion, 0, 0, 5)

        sbSizer3.Add(bSizer10, 0, wx.EXPAND, 5)

        self.m_staticText61 = wx.StaticText(sbSizer3.GetStaticBox(), wx.ID_ANY, u"解密后裁切(宽)", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText61.Wrap(-1)

        sbSizer3.Add(self.m_staticText61, 0, wx.ALIGN_CENTER_HORIZONTAL, 5)

        self.origWidth = wx.SpinCtrl(sbSizer3.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTER_HORIZONTAL | wx.SP_ARROW_KEYS | wx.TE_PROCESS_ENTER, 1, 1, 1)
        self.origWidth.SetToolTip(u"在解密操作后对结果进行裁切，最佳值即为被加密图像加密前的原始大小")

        sbSizer3.Add(self.origWidth, 0, wx.EXPAND, 5)

        self.m_staticText611 = wx.StaticText(sbSizer3.GetStaticBox(), wx.ID_ANY, u"解密后裁切(高)", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText611.Wrap(-1)

        sbSizer3.Add(self.m_staticText611, 0, wx.ALIGN_CENTER_HORIZONTAL, 5)

        self.origHeight = wx.SpinCtrl(sbSizer3.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTER_HORIZONTAL | wx.SP_ARROW_KEYS | wx.TE_PROCESS_ENTER, 1, 1, 1)
        self.origHeight.SetToolTip(u"在解密操作后对结果进行裁切，最佳值即为被加密图像加密前的原始大小")

        sbSizer3.Add(self.origHeight, 0, wx.EXPAND, 5)

        bSizer1.Add(sbSizer3, 1, wx.ALL | wx.EXPAND, 3)
        ...
        self.coreVersion.Bind(wx.EVT_SPINCTRL, self.settings_changed)
        self.coreVersion.Bind(wx.EVT_TEXT_ENTER, self.settings_changed)
        self.origWidth.Bind(wx.EVT_SPINCTRL, self.settings_changed)
        self.origWidth.Bind(wx.EVT_TEXT_ENTER, self.settings_changed)
        self.origHeight.Bind(wx.EVT_SPINCTRL, self.settings_changed)
        self.origHeight.Bind(wx.EVT_TEXT_ENTER, self.settings_changed)
