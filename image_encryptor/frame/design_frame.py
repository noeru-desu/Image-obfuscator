...
class MainFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.LoadFileBtn = wx.Button( self, wx.ID_ANY, u"选择文件", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.LoadFileBtn.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_BTNTEXT ) )
        self.LoadFileBtn.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )

        gSizer9.Add( self.LoadFileBtn, 0, wx.ALIGN_RIGHT|wx.ALL, 20 )

        self.imageInfo = wx.StaticText( self, wx.ID_ANY, u"图像信息：未载入图片", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        fgSizer6.Add( gSizer9, 1, wx.EXPAND, 5 )
        ...
        self.mode.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWTEXT ) )
        self.mode.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )
        ...
        self.rgbMapping.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWTEXT ) )
        self.rgbMapping.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )
        ...
        self.row = wx.SpinCtrl( self.processingOptions, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 1, 100000000, 25 )
        self.row.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWTEXT ) )
        self.row.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )
        ...
        self.col = wx.SpinCtrl( self.processingOptions, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 1, 100000000, 25 )
        self.col.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWTEXT ) )
        self.col.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )
        ...
        self.m_staticText12 = wx.StaticText( self.processingOptions, wx.ID_ANY, u"加密/解密密码", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.password = wx.TextCtrl( self.processingOptions, wx.ID_ANY, u"none", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.password.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWTEXT ) )
        self.password.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )
        ...
        self.processPool = wx.SpinCtrl( self.processingOptions, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 1, 10, 1 )
        self.processPool.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWTEXT ) )
        self.processPool.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )
        ...
        self.previewProgress = wx.Gauge( self.processingOptions, wx.ID_ANY, 100, wx.DefaultPosition, wx.DefaultSize, wx.GA_HORIZONTAL )
        ...
        self.m_staticText22 = wx.StaticText( self, wx.ID_ANY, u"保存格式", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText22.Wrap( -1 )

        self.m_staticText22.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWTEXT ) )

        gSizer101.Add( self.m_staticText22, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT|wx.ALL, 5 )
        ...
        self.selectFormat = wx.Choice( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, selectFormatChoices, 0 )
        self.selectFormat.SetSelection( 21 )
        self.selectFormat.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWTEXT ) )
        self.selectFormat.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )

        gSizer101.Add( self.selectFormat, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 0 )

        self.m_button7 = wx.Button( self, wx.ID_ANY, u"保存文件", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_button7.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_BTNTEXT ) )
        self.m_button7.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )

        gSizer101.Add( self.m_button7, 0, wx.ALL, 20 )

        self.m_gauge1 = wx.Gauge( self, wx.ID_ANY, 100, wx.DefaultPosition, wx.DefaultSize, wx.GA_HORIZONTAL )
        self.m_gauge1.SetValue( 0 )
        gSizer101.Add( self.m_gauge1, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_LEFT|wx.ALL|wx.EXPAND, 5 )


        fgSizer6.Add( gSizer101, 1, wx.EXPAND, 5 )
        ...
        self.LoadFileBtn.Bind( wx.EVT_BUTTON, self.load_file )
        ...
        self.password.Bind( wx.EVT_TEXT, self.refresh_preview )
