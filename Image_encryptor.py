...
from modules.image_cryptor import generate_encrypted_image, get_encrypted_lists
...
bar = ProgressBar(max_value=col * row, widgets=widgets)
new_image = generate_encrypted_image(regions, flip_list, pw, row, col, block_width, block_height, rgb_mapping, program.parameter['xor_alpha'], bar=bar)
